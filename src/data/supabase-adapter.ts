// Hosted/Lovable mode adapter. This is a pure extraction of the original
// Supabase calls that previously lived inside the hooks — behaviour is
// unchanged.
...
export const supabaseAdapter: DataAdapter = {
  ...
  articles: {
    ...
    async save(input: ArticleInput): Promise<Article> {
